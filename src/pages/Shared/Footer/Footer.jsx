import fresh from "../../../assets/fresh mart logo.png";
    ...
    <div>
      <footer className="footer p-10 bg-gray-800 text-white">
        <nav>
          ...
          <a className="link link-hover">Fruits & Vegetables</a>
      ...
      <footer className="footer px-10 py-4 border-t  bg-gray-800 text-white border-base-300">
        <aside className="items-center grid-flow-col">
          <img className="h-10 w-10 border border-black" src={fresh} alt="" />
          <p>
            Fresh Mart Store <br />
            Providing fresh groceries since 1992
          </p>
        </aside>
